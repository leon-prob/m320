...
-- SAFE FOR create-drop + run every startup
-- Uses ON CONFLICT DO NOTHING to prevent duplicates

SET search_path TO blj;

-- === GARAGES ===
INSERT INTO blj.car_garage (garage_id, name)
VALUES
    (1, 'Zurich Downtown'),
    (2, 'Bern City'),
    (3, 'Basel Garage'),
...
-- === USERS ===
INSERT INTO blj."user" (user_id, firstname, lastname, email, password, role, is_banned, age)
VALUES
...
-- === CARS ===
INSERT INTO blj.car (id, brand, model, required_age, maximum_rental_period_in_days, category, release_date, price_per_day, garage_id)
VALUES
...
-- === LOAN CONTRACTS ===
INSERT INTO blj.loan_contract (loan_id, start_date, end_date, id_car, id_customer, id_car_garage, loan_status)
VALUES
    ('0f1eeb99-acdb-4a1c-ba60-b725d4f9c86f', '2026-03-01', '2026-04-30',
     'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a13', -- Porsche
     '9b8c7d6e-5f4b-4c3a-9f2e-3a2b1c0d9e8f', -- Some user
     1, -- Some garage?
     'OPEN')
